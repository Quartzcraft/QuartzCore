package uk.co.quartzcraft.core.command.framework;
 ...
 * 
 */
public class QCommandFramework {
	 ...
	 * @param plugin
	 */
	public QCommandFramework(Plugin plugin) {
		this.plugin = plugin;
	...
	public void registerCommands(Object obj) {
		for (Method m : obj.getClass().getMethods()) {
			if (m.getAnnotation(QCommand.class) != null) {
				QCommand command = m.getAnnotation(QCommand.class);
	...
	private void registerCommand(QCommand command, String label, Method m, Object obj) {
